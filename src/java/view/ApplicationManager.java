...
/**
 *
 * This class handles user application for a job position. The class receives
 * the data entered from web pages through a jsf conversation which stays alive
 * during the whole servlet request. The main purpose of the class is to receive
 * the user input, collect it together into an application and save it through
 * calling the ApplyHandler in the controller
 */
...
public class ApplicationManager implements Serializable {
    ...
    /**
     * Method to get saved competences. Used by jsf requests during the render
     * response phase.
     *
    ...
    /**
     * Called by a jsf request to set the values of the entrered competence
     * input from multiple checkbox values. Called during the Update Model
     * Values Phase
     *
    ...
    /**
     * Called by a jsf request to set the values of the entrered description
     * input. Called during the Update Model Values Phase.
     *
    ...
    /**
     * Method that compiles all user input into an application by calling the
     * applyHandler in the controller. Also controls that the user is logged in
     * by checking the current session.
     */
    ...
    /**
     * Method to get saved experience. Used by jsf requests during the render
     * response phase.
     *
    ...
    /**
     * Called by a jsf request to set the values of the entrered input. Called
     * during the Update Model Values Phase. Checks so that it conforms to form
     * "YYYY-MM-DD".
     *
    ...
    /**
     * Method to get saved start date. Used by jsf requests during the render
     * response phase.
     *
    ...
    /**
     * Method to get saved end date. Used by jsf requests during the render
     * response phase.
     *
    ...
    /**
     * Method to get saved years of experience. Used by jsf requests during the
    ...
    /**
     * Method to get saved first name. Used by jsf requests during the render
     * response phase.
     *
    ...
    /**
     * Method to get saved last name. Used by jsf requests during the render
     * response phase.
     *
    ...
    /**
     * Method to get saved email. Used by jsf requests during the render
     * response phase.
     *
    ...
    /**
     * Method to get saved social security number. Used by jsf requests during
